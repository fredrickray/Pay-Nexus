        ...
        <div className="sidenav-header">
          ...
          <Link className="navbar-brand m-0" to="/Home/Profile" target="_blank">
            <img
              ...
              alt="main_logo"
            />
            <span className="ms-1 font-weight-bold">{username} Dashboard </span>
          </Link>
        </div>
                ...
                <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
                  ...
                  >
                    <div class="sidenav-toggler-inner">
                      <i class="sidenav-toggler-line bg-white" />
                      <i class="sidenav-toggler-line bg-white" />
                      <i class="sidenav-toggler-line bg-white" />
                    </div>
                  </a>
                      ...
                      >
                        <div class="d-flex py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">
                              <i class="fa fa-clock me-1" />1 day
                            </p>
                          </div>
                        </div>
                      </a>
                      ...
                      >
                        <div class="d-flex py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">
                              <i class="fa fa-clock me-1" />2 days
                            </p>
                          </div>
                        </div>
                      </a>
                ...
                <div class="card-body p-3">
                  <ul class="list-group">
                    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                      <div class="d-flex align-items-center">
                        <div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                          <i class="ni ni-mobile-button text-white opacity-10" />
                        </div>
                      ...
                      <div class="d-flex">
                        <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                          <i class="ni ni-bold-right" aria-hidden="true" />
                        </button>
                      </div>
                    </li>
                    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                      <div class="d-flex align-items-center">
                        <div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                          <i class="ni ni-tag text-white opacity-10" />
                        </div>
                        <div class="d-flex flex-column">
                    ...
                    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                      <div class="d-flex align-items-center">
                        <div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                          <i class="ni ni-box-2 text-white opacity-10" />
                        </div>
                        <div class="d-flex flex-column">
                    ...
                    <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                      <div class="d-flex align-items-center">
                        <div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                          <i class="ni ni-satisfied text-white opacity-10" />
                        </div>
                        <div class="d-flex flex-column">
